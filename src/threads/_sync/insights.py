...
class InsightsClient(BaseInsightsClient):
    """Synchronous client for insights operations."""
    ...
    def get_views(self, media_id: str) -> int:
        ...
        Returns:
            Number of views.
        """
        insights = self.get_media_insights(media_id, [MetricType.VIEWS])
        return insights.views

    def get_engagement(self, media_id: str) -> dict[str, int]:
