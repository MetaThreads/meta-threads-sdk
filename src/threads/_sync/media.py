...
class MediaClient(BaseMediaClient):
    """Synchronous client for media container operations."""
    ...
    def get_container_status(self, container_id: str) -> MediaContainerStatus:
